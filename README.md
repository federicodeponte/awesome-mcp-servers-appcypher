...
- [Floom](https://github.com/floomhq/floom) - Deploy and run Python functions as web apps with auto-generated UI, REST API, and Docker sandboxing via MCP. 32 tools for deploy, run, storage, secrets, scheduling, versioning, and sharing.
