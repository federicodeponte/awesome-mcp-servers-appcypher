...
- [Floom](https://github.com/floomhq/floom) - Deploy Python functions as live web apps with auto-generated UI, REST API, and shareable links. Self-hosted with Docker.
